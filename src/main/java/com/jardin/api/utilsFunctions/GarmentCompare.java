...
public class GarmentCompare {
  ...
  public static boolean compareByMainColorOfGarment(
    String mainColor,
    String queryMainColor
  ) {
    if (queryMainColor == null) return true;
    return mainColor.equals(queryMainColor);
  }

  public static boolean compareByGenderOfGarment(
    String gender,
    String queryGender
  ) {
  ...
  //String mainMaterial
  public static boolean compareByMainMaterialOfGarment(
    String mainMaterial,
    String queryMainMaterial
  ) {
  ...
  //String madeIn
  public static boolean compareByMadeInOfGarment(
    String madeIn,
    String queryMadeIn
  ) {
  ...
  //Integer price
  public static boolean compareByPriceOfGarment(
    Integer price,
    Integer queryPrice
  ) {
  ...
  //String comment
  public static boolean compareByCommentGarment(
    String comment,
    String queryComment
  ) {
